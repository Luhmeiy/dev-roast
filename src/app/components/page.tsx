	...
	return (
		<div className="min-h-screen bg-zinc-50 p-8">
			...
			<section>
				...
				<div className="mb-6">
					<h3 className="text-sm mb-2 text-zinc-700">Variants</h3>
				...
				<div className="mb-6">
					<h3 className="text-sm mb-2 text-zinc-700">Sizes</h3>
					<div className={section.grid}>
			...
			<section>
				...
				<div className="mb-6">
					<h3 className="text-sm mb-2 text-zinc-700">
				...
				<div className="mb-6">
					<h3 className="text-sm mb-2 text-zinc-700">Controlled</h3>
			...
			<section>
				...
				<div className="mb-6">
					<h3 className="text-sm mb-2 text-zinc-700">Scores</h3>
			...
			<section>
				...
				<div className="mb-6">
					<h3 className="text-sm mb-2 text-zinc-700">Default</h3>
					<CodeBlock
